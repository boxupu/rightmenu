function hideRightMenu (currentSize) {
  if (document.querySelector(".tt_right_menu")) {
    document.querySelector(".tt_right_menu").remove()
  }
    ...
    install: function (Vue, options) {
        ...
        Vue.directive("rightMenu", {
            bind(el, binding, vnode) {
                ...
                if (!document.getElementById("TT_MASK")) {
                    ...
                    if (!document.getElementById("tt_right_menu" + currentSize)) {
                        ...
                        binding.value["menus"].map((item) => {
                            ...
                            if (item.callback) {
                                ...
                                optionp.onclick = _ => {
                                  vnode.context[item.callback](vnode.data.attrs.data)
                                  console.log('aaa')
                                  hideRightMenu()
                                }
                            } else {
                        ...
                        boxDiv.className = 'tt_right_menu';
                ...
                GLOBLEsize++;
                document.getElementById("TT_MASK").addEventListener("click", hideRightMenu)
                document.getElementById("TT_MASK").addEventListener("contextmenu", hideRightMenu)

            },
            unbind(el) {
                el.removeEventListener("contextmenu", hideRightMenu);
            }
        })
    }
}
